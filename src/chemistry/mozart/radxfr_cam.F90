module radxfr_cam
  ...
  integer, parameter  :: nintegrals = 22
...
contains
  subroutine radxfr_cam_readnl(nlfile)
    ...
    namelist /photo_radxfr_opts/ radxfr_wavelength_grid_file, radxfr_input_data_root, radxfr_has_aer_ra_feedback, radxfr_do_tuv_photo
